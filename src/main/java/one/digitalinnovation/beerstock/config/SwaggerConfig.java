...
public class SwaggerConfig {
    ...
    private static final String CONTACT_NAME = "Ronaldo Scortegagna";
    private static final String CONTACT_GITHUB = "https://gtihub.com/ronaldoscortegagna";
    private static final String CONTACT_EMAIL = "ronaldoscortegagna@hotmail.com";
